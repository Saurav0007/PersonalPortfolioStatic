...
<head>
    <title>Saurav the Developer </title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="mh-header-info">
                            ...
                            <ul>
                                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i
                                        class="fa fa-envelope"></i><a href="mailto:">saiyedsaurav@gmail.com</a></li>
                            ...
                            <ul class="social-icon wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                <li><a href="https://www.facebook.com/Mohammad.saurav07/"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/saiyed_showrov/"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.github.com/Saurav0007"><i class="fa fa-github"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/mahmudulhasansaurav/"><i class="fa fa-linkedin"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                            <div class="img-border">
                                <img src="assets/images/officialME.jpg" style="height: 100%; width:auto;" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row section-separator">
                <div class="col-sm-12 col-md-6">
                    <div class="mh-about-img shadow-2 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                        <img src="assets/images/ab_1.jpg" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="mh-about-inner">
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">About Me</h2>
                        <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Hello, I’m a Mahmudul Hasan Saurav,
                            web-developer in Bangladesh.
                            I have some experience in web site design & building
                            and customization. Also I am good at the things you can see below.</p>
                        ...
                        <a href="assets/pdf/SMD_Saurav_laravel_Developer_DIU.pdf" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s"
            ...
            <div class="row section-separator">
                ...
                <div class="col-sm-4">
                    <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                        ...
                        <h3>Web Design</h3>
                        <p>
                            I can design a full responsive template with HTML,CSS,Bootstrap and with my little creativity it will look awesome. 
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                        ...
                        <p>
                            I can partially develop a system from Scratch with PHP (Laravel), Ajax, Vue js.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                        ...
                        <p>
                            With certain amount knowledge i have, i can easily Edit the template you want.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="mh-education">
                            ...
                            <div class="mh-education-deatils">
                                ...
                                <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                    data-wow-delay="0.3s">
                                    <h4>Software Engineering From <a href="#">Daffodil International University</a></h4>
                                ...
                                <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                    data-wow-delay="0.5s">
                                    <h4>Higher Secondery Certificate From <a href="#">chandpur govt. college</a></h4>
                                ...
                                <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                    data-wow-delay="0.6s">
                                    <h4>Secondery school certificate From <a href="#">Chandpur Govt. Technical high School, Chandpur </a></h4>
                ...
                <div class="part col-sm-12">
                    <div class="portfolio-nav col-sm-12" id="filter-button">
                        <ul>
                            ...
                            <li data-filter=".Web-design-development" class="wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.2s"><span>Web Design & Development</span></li>
                        </ul>
                    </div>
                    <div class="mh-project-gallery col-sm-12 wow fadeInUp" id="project-gallery"
                        data-wow-duration="0.8s" data-wow-delay="0.5s">
                        <div class="portfolioContainer row">
                            <div class="grid-item col-md-4 col-sm-6 col-xs-12 Web-design-development">
                                <figure>
                                    <img src="assets/images/portfolio/pr_1.png" alt="img04">
                                    <figcaption class="fig-caption">
                                        <i class="fa fa-search"></i>
                                        <h5 class="title">EduAava</h5>
                                        <span class="sub-title">Web-Development</span>
                                        <a data-fancybox data-src="#mh1"></a>
                                    </figcaption>
                                </figure>
                            </div>           
        ...
        <div class="mh-portfolio-modal" id="mh1">
            <div class="container">
                <div class="row mh-portfolio-modal-inner">
                    <div class="col-sm-5">
                        <h2>EduAava-A Erp System</h2>
                        <p>
                            It's a education E-commerce type system where we have planted multivendor system and multiple payment system.
                            very understandable UI for user.
                        </p>
                        ...
                        <a href="https://eduaava.com/" class="btn btn-fill">Live Demo</a>
                    </div>
                    <div class="col-sm-7">
                        <div class="mh-portfolio-modal-img">
                            <img src="assets/images/portfolio/pr_2.png" alt="" class="img-fluid">
                            <p>Some inside picture of Website</p>
                            <img src="assets/images/portfolio/pr_3.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        ...
                        <div class="blog-inner">
                            <h2><a href="blog-single.html">A life with daily Programming</a></h2>
                            <div class="mh-blog-post-info">
                                <ul>
                                    <li><strong>Post On</strong><a href="#">.....</a></li>
                                    <li><strong>By</strong><a href="#">Saurav</a></li>
                                </ul>
                            </div>
                            <p>Coming soon....</p>
            ...
            <div class="container">
                <div class="row section-separator">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp"
                                    ...
                                    <div class="each-info">
                                        <h4>Email</h4>
                                        <a href="mailto:yourmail@email.com">saiyedsaurav@gmail.com</a><br>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp"
                                    ...
                                    <div class="each-info">
                                        <h4>Phone</h4>
                                        <a href="callto:(880)-8976-987">01629697898</a><br>
                    ...
                    <div class="col-sm-12 col-md-6 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        <form  class="single-form quate-form wow fadeInUp">
                            @csrf
                            {{-- action="/sendMessage" method="POST" --}}
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <input name="firstName" class="contact-name form-control" type="text"
                                        placeholder="First Name" required>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input name="lastName" class="contact-email form-control" type="text"
                                        placeholder="Last Name" required>
                                </div>
                                <div class="col-sm-12">
                                    <input name="email" class="contact-subject form-control" type="email"
                                ...
                                <div class="btn-form col-sm-12">
                                    <button type="submit" class="btn btn-fill btn-block">Send
                                        Message</button>
                                </div>
                            </div>
                        </form>
    ...
    * JS Files *
    ...
    {{-- //messenger button start// --}}
        ...
        <script>
          ...
          chatbox.setAttribute("page_id", "110424408178532");
